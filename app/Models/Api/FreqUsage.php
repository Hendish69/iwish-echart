...
class FreqUsage extends Model
{
	protected $table = 'freq_used';
  ...
  public function callsign()
	{
		return $this->hasMany(Frequency::class, 'id', 'freqid');
  }
  ...
  public function airspace()
	{
		return $this->hasMany(Airspace::class, 'ats_airspace_id', 'asp_id');
  }
