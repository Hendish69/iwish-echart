...
class ProfilesController extends Controller
{
    ...
    {
        return User::with('profile')->where('email','=',$email)->firstOrFail();
    }
    /**
     ...
     * @return Response
     */
    public function createNewProfile($email){
    ...
    public function edit($email)
    {
    	...
    	// if($user->profile!=null)
        if($user->profile==null){ 
            $this->createNewProfile($user->email);    
        }
        if($user->profile!=null)
            $currentTheme = Theme::find($user->profile->theme_id);
    ...
    public function updateUserAccount(Request $request, $id)
    {
        ...
        return redirect('profile/'.$user->email.'/edit')->with('success', trans('profile.updateAccountSuccess'));
    }
    ...
    public function updateUserPassword(UpdateUserPasswordRequest $request, $id)
    {
        ...
        return redirect('profile/'.$user->email.'/edit')->with('success', trans('profile.updatePWSuccess'));
    }
    ...
    public function deleteUserAccount(DeleteUserAccount $request, $id)
    {
        ...
        if ($user->id !== $currentUser->id) {
            return redirect('profile/'.$user->email.'/edit')->with('error', trans('profile.errorDeleteNotYour'));
        }
