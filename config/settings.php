...
return [
     ...
     * ReCaptcha Site Key
     */
    'reCaptchSite'   => env('RE_CAP_SITE', '6LeoMgAaAAAAANLOCTXcewUuqMV8emxMsU-eVnym'),

    /*
     * ReCaptcha Secret
     */
    'reCaptchSecret' => env('RE_CAP_SECRET', '6LeoMgAaAAAAAIqOUdHJshDl7Dgm9sWwC7t0WOQM'),
     ...
     * Google Maps API Key
     */
    'googleMapsAPIKey'    => env('GOOGLEMAPS_API_KEY', 'AIzaSyA3Q2fPyLGyxzAN_0WstOuvNcKvWm-tSeM'),
