                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                                                ...
                                                {!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->email], 'id' => 'user_profile_form', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                                                    {{ csrf_field() }}
                                                    <div class="row">
                                                    ...
                                                    <div class="mb-2 form-group has-feedback {{ $errors->has('github_username') ? ' has-error ' : '' }}">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <div class="col-12">
                                                            {!! Form::button(
                                                                '<em class="icon ni ni-save"></em> ' . trans('profile.submitButton'),
                                                                 array(
                                                                    'id'                => 'confirmFormSave',
                                            ...
                                            <div class="tab-pane fade edit-settings-tab" role="tabpanel" aria-labelledby="edit-settings-tab">
                                                {!! Form::model($user, array('action' => array('ProfilesController@updateUserAccount', $user->id), 'method' => 'PUT', 'id' => 'user_basics_form')) !!}
                                                    ...
                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                                                        ...
                                                        {!! Form::label('name', 'Fullname', array('class' => 'col-md-3 control-label')); !!}
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <label class="input-group-text" for="name">
                                                                        <em class="icon ni {{ trans('forms.create_user_icon_username') }}" ></em>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            @if($errors->has('name'))
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <label for="email" class="input-group-text">
                                                                        <em class="icon ni {{ trans('forms.create_user_icon_email') }}"></em>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            @if ($errors->has('email'))
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <label class="input-group-text" for="first_name">
                                                                        <em class="icon ni {{ trans('forms.create_user_icon_firstname') }}"></em>
                                                                    </label>
                                                                </div>
                                                            </div>
...
<!-- 
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <label class="input-group-text" for="last_name">
                                                                        <em class="icon ni {{ trans('forms.create_user_icon_lastname') }}"></em>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-9 offset-md-3">
                                                            {!! Form::button(
                                                                '<em class="icon ni ni-save"></em> ' . trans('profile.submitProfileButton'),
                                                                 array(
                                                                    'class'             => 'btn btn-success disabled',
                                            ...
                                            <div class="tab-pane fade edit-account-tab" role="tabpanel" aria-labelledby="edit-account-tab">
                                                <ul class="account-admin-subnav nav nav-pills nav-justified mb-3 mt-1">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="changepw" class="tab-pane fade show active">
                                                        ...
                                                        <h3 class="mb-1 text-center text-warning">
                                                        ...
                                                        {!! Form::model($user, array('action' => array('ProfilesController@updateUserPassword', $user->id), 'method' => 'PUT', 'autocomplete' => 'new-password')) !!}
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-9 offset-md-3">
                                                                    {!! Form::button(
                                                                        '<em class="icon ni ni-save"></em> ' . trans('profile.submitPWButton'),
                                                                         array(
                                                    ...
                                                    <div id="deleteAccount" class="tab-pane fade">
                                                        ...
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-sm-6 offset-sm-3 mb-3 text-center">

                                                                {!! Form::model($user, array('action' => array('ProfilesController@deleteUserAccount', $user->id), 'method' => 'DELETE')) !!}

                                                                    <div class="btn-group btn-group-vertical mb-2 custom-checkbox-fa" data-toggle="buttons">
                                                                        <label class="btn no-shadow" for="checkConfirmDelete" >
                                                                            <input type="checkbox" name='checkConfirmDelete' id="checkConfirmDelete" class="form-control">
                                                                            ...
                                                                            <span class="ml-2"> Confirm Account Deletion</span>
                                                                        </label>
                                                                    </div>

                                                                    {!! Form::button(
                                                                        '<em class="icon ni ni-trash"></em> ' . trans('profile.deleteAccountBtn'),
                                                                        array(
...
@section('footer_scripts')
    ...
    {{-- endif --}}
    @include('scripts.location-search')
