                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="role">
                                                ...
                                                <em class="{{ trans('forms.create_user_icon_role') }}"></em>
                                            </label>
                                        </div>
                                    </div>
                                    @if ($errors->has('role'))
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="custom-select form-control" name="pia_id" id="pia_id">
                                            ...
                                            @if ($pias)
                                                @foreach($pias as $pia)
                                                    <option value="{{ $pia->id }}">{{ $pia->name .' | ' . $pia->pia }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        <div class="input-group-append">
                                    ...
                                    @if ($errors->has('pia_ia'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('pia_ia') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="password">
                                                ...
                                                <em class="icon ni {{ trans('forms.create_user_icon_password') }}"></em>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="password_confirmation">
                                                ...
                                                <em class="icon ni {{ trans('forms.create_user_icon_pw_confirmation') }}"></em>
                                            </label>
                                        </div>
                                    </div>
