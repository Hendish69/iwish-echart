                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="{{ url('/users/' . $user->id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('usersmanagement.tooltips.back-user') }}">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="name">
                                                <i class="icon ni {{ trans('forms.create_user_icon_username') }}" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                                    @if($errors->has('name'))
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="first_name">
                                                <i class="icon ni {{ trans('forms.create_user_icon_firstname') }}" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="last_name">
                                                <i class="icon ni {{ trans('forms.create_user_icon_lastname') }}" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label for="email" class="input-group-text">
                                                <i class="icon ni {{ trans('forms.create_user_icon_email') }}" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                                    @if ($errors->has('email'))
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('pia_id') ? ' has-error ' : '' }}" id="pia_div">
                                {!! Form::label('pia_id', 'PIA', array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="custom-select form-control" name="pia_id" id="pia_id">
                                            <option value="">-- select --</option>
                                            @if ($pias)
                                                @foreach($pias as $pia)
                                                    <option value="{{ $pia->id }}" {{ $user->pia_id == $pia->id ? 'selected="selected"' : '' }}>{{ $pia->name .' | ' . $pia->pia }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        <div class="input-group-append">
                                    ...
                                    @if ($errors->has('pia_id'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('pia_id') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <label class="input-group-text" for="password">
                                                    <i class="icon ni {{ trans('forms.create_user_icon_password') }}" aria-hidden="true"></i>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <label class="input-group-text" for="password_confirmation">
                                                    <i class="icon ni {{ trans('forms.create_user_icon_pw_confirmation') }}" aria-hidden="true"></i>
                                                </label>
                                            </div>
                                        </div>
