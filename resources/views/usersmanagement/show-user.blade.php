              ...
              <div class="col-sm-4 col-md-6">
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    {!! Form::open(array('url' => 'users/' . $user->id, 'class' => 'form-inline', 'style'=>'margin-top:-30px' ,'data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => trans('usersmanagement.deleteUser'))) !!}
