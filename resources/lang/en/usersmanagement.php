...
return [
    ...
    'buttons' => [
        ...
        'delete'        => '<em class="icon ni ni-trash"></em>  <span class="hidden-xs hidden-sm">Delete</span><span class="hidden-xs hidden-sm hidden-md"> User</span>',
        'show'          => '<em class="icon ni ni-eye"></em> <span class="hidden-xs hidden-sm">Show</span><span class="hidden-xs hidden-sm hidden-md"> User</span>',
        'edit'          => '<em class="icon ni ni-edit-alt"></em> <span class="hidden-xs hidden-sm">Edit</span><span class="hidden-xs hidden-sm hidden-md"> User</span>',
        ...
        'delete-user'   => '<em class="icon ni ni-trash"></i>  <span class="hidden-xs">Delete</span><span class="hidden-xs"> User</span>',
        'edit-user'     => '<em class="icon ni ni-edit-alt"></em> <span class="hidden-xs">Edit</span><span class="hidden-xs"> User</span>',
    ],
