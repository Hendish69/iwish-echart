...
1. Run `git clone https://github.com/heru4nomo/iwish.git laravel-project`
2. Create a Postgre database for the project
...
10. From the projects root folder run `php artisan cache:clear`
